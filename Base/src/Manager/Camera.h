...
public:
	...
	static constexpr VECTOR FOLLOW_CAMERA_LOCAL_POS = { 0.0f, 3500.0f, -2000.0f };
	//static constexpr VECTOR FOLLOW_CAMERA_LOCAL_POS = { 0.0f, 3000.0f, -1000.0f };

	//// 追従位置から注視点までの相対座標
	//static constexpr VECTOR FOLLOW_TARGET_LOCAL_POS = { 0.0f, 300.0f, 500.0f };
	//static constexpr VECTOR FOLLOW_TARGET_LOCAL_POS = { 0.0f, 800.0f, 0.0f };
	static constexpr VECTOR FOLLOW_TARGET_LOCAL_POS = { 0.0f, 1200.0f, -300.0f };
